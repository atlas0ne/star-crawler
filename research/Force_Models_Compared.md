...
- Saga (from torrent) and FFG (OCR in progress) sections.
- SWN ch. 5 read for the Effort mechanism, properly.
- A reviewed never-list pass over the 76 WEG powers, by hand, not regex.
- `weg_force → shapes`: map the 76 to the 55, as `Species_Shape_Fit.md` will for species.
