---
title: "Class Models Compared"
status: SCAFFOLD
---

# Class Models Compared
...
- Saga core ch. 3 from OCR; the talent-tree structure and Force Sensitivity feat.
- Heroes & Rogues' build-a-template chapter.
- Traveller careers and Star Frontiers PSAs from the books.
